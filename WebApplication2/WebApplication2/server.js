...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['chat'].server = {
            ...
            /// <summary>Calls the SendMessageData method on the server-side chat hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"data\" type=\"Object\">Server side type is WebApplication2.SendData</param>
    ...
    signalR.hub = $.hubConnection("http://localhost:44251/", { useDefaultPath: false });
